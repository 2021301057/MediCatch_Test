...
/**
 * 상단 네비게이션바 — MediCatch 디자인 handoff에 맞춰 재작성
 * 기존 좌측 Sidebar를 대체합니다.
 */
const NAV_ITEMS = [
      ...
      <div className="mc-navbar-inner">
        ...
        <div className="mc-nav-right">
          <span className="mc-sync-note">
            ...
            {syncing ? '동기화 중…' : '5분 전 동기화'}
          </span>
          <button className="mc-btn" onClick={handleSync} disabled={syncing} title="CODEF 데이터 갱신">
            <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.6"
              strokeLinecap="round" strokeLinejoin="round"
              style={{
