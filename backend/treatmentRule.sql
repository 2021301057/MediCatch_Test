-- MediCatch treatment and insurance benefit rule seeds
-- Run after init.sql creates medicatch_analysis rule tables.
...
SET synonyms = '위암,대장암,폐암,갑상선암,유사암,고액암'
WHERE keyword = '암'
  AND synonyms LIKE '%암진단%';
INSERT INTO treatment_rules (keyword, synonyms, injury_disease_type, care_type, benefit_type, treatment_category, actual_loss_category, fixed_benefit_category, needs_user_confirmation, caution_message, priority)
SELECT '골절', '뼈 골절,발목 골절,손목 골절', 'INJURY', 'DIAGNOSIS', 'UNKNOWN', 'FRACTURE', NULL, 'FRACTURE_DIAGNOSIS', FALSE, '골절 진단비는 골절 부위와 담보별 제외 조건에 따라 보장 여부가 달라질 수 있습니다.', 20
WHERE NOT EXISTS (SELECT 1 FROM treatment_rules WHERE keyword = '골절');
UPDATE treatment_rules
SET synonyms = '뼈 골절,발목 골절,손목 골절',
    caution_message = '골절 진단비는 골절 부위와 담보별 제외 조건에 따라 보장 여부가 달라질 수 있습니다.'
WHERE keyword = '골절'
  AND synonyms LIKE '%치아파절%';
INSERT INTO treatment_rules (keyword, synonyms, injury_disease_type, care_type, benefit_type, treatment_category, actual_loss_category, fixed_benefit_category, needs_user_confirmation, caution_message, priority)
...
INSERT INTO treatment_rules (keyword, synonyms, injury_disease_type, care_type, benefit_type, treatment_category, actual_loss_category, fixed_benefit_category, needs_user_confirmation, caution_message, priority)
SELECT '폐렴', '기관지폐렴,폐감염,호흡기감염', 'DISEASE', 'OUTPATIENT', 'COVERED', 'GENERAL', 'GENERAL_OUTPATIENT', NULL, TRUE, '외래 치료인지 입원 치료인지에 따라 실손 및 입원일당 담보 확인이 달라질 수 있습니다.', 106
WHERE NOT EXISTS (SELECT 1 FROM treatment_rules WHERE keyword = '폐렴');
UPDATE treatment_rules
SET care_type = 'OUTPATIENT',
    actual_loss_category = 'GENERAL_OUTPATIENT',
    fixed_benefit_category = NULL,
    needs_user_confirmation = TRUE
WHERE keyword = '폐렴'
  AND fixed_benefit_category = 'HOSPITALIZATION_DAILY';
INSERT INTO treatment_rules (keyword, synonyms, injury_disease_type, care_type, benefit_type, treatment_category, actual_loss_category, fixed_benefit_category, needs_user_confirmation, caution_message, priority)
SELECT '백내장', '인공수정체,다초점렌즈,노안', 'DISEASE', 'OUTPATIENT', 'MIXED', 'GENERAL', 'GENERAL_OUTPATIENT', NULL, TRUE, '수술 여부, 렌즈 종류, 급여/비급여 여부에 따라 보장 판단이 달라질 수 있습니다.', 107
WHERE NOT EXISTS (SELECT 1 FROM treatment_rules WHERE keyword = '백내장');
UPDATE treatment_rules
SET synonyms = '인공수정체,다초점렌즈,노안',
    care_type = 'OUTPATIENT',
    treatment_category = 'GENERAL',
    actual_loss_category = 'GENERAL_OUTPATIENT',
    fixed_benefit_category = NULL,
    caution_message = '수술 여부, 렌즈 종류, 급여/비급여 여부에 따라 보장 판단이 달라질 수 있습니다.'
WHERE keyword = '백내장'
  AND fixed_benefit_category = 'SURGERY_BENEFIT';
INSERT INTO treatment_rules (keyword, synonyms, injury_disease_type, care_type, benefit_type, treatment_category, actual_loss_category, fixed_benefit_category, needs_user_confirmation, caution_message, priority)
SELECT '백내장수술', '백내장 수술,인공수정체삽입술,수정체수술', 'DISEASE', 'SURGERY', 'MIXED', 'SURGERY', 'GENERAL_SURGERY', 'SURGERY_BENEFIT', TRUE, '렌즈 종류와 급여/비급여 여부에 따라 실손 및 수술비 담보 판단이 달라질 수 있습니다.', 107
WHERE NOT EXISTS (SELECT 1 FROM treatment_rules WHERE keyword = '백내장수술');
INSERT INTO treatment_rules (keyword, synonyms, injury_disease_type, care_type, benefit_type, treatment_category, actual_loss_category, fixed_benefit_category, needs_user_confirmation, caution_message, priority)
...
INSERT INTO treatment_rules (keyword, synonyms, injury_disease_type, care_type, benefit_type, treatment_category, actual_loss_category, fixed_benefit_category, needs_user_confirmation, caution_message, priority)
SELECT '초음파', '복부초음파,갑상선초음파,유방초음파,심장초음파', 'UNKNOWN', 'TEST', 'MIXED', 'IMAGING', 'GENERAL_OUTPATIENT', NULL, TRUE, '초음파는 급여/비급여 여부와 검사 목적에 따라 실손 보장 기준이 달라질 수 있습니다.', 109
WHERE NOT EXISTS (SELECT 1 FROM treatment_rules WHERE keyword = '초음파');
UPDATE treatment_rules
SET actual_loss_category = 'GENERAL_OUTPATIENT',
    caution_message      = '초음파는 급여/비급여 여부와 검사 목적에 따라 실손 보장 기준이 달라질 수 있습니다.'
WHERE keyword = '초음파'
  AND actual_loss_category = 'NON_COVERED_THREE';
INSERT INTO treatment_rules (keyword, synonyms, injury_disease_type, care_type, benefit_type, treatment_category, actual_loss_category, fixed_benefit_category, needs_user_confirmation, caution_message, priority)
SELECT 'CT', '컴퓨터단층촬영,씨티,CT검사,복부CT,흉부CT', 'UNKNOWN', 'TEST', 'MIXED', 'IMAGING', 'GENERAL_OUTPATIENT', NULL, TRUE, 'CT는 급여/비급여 여부와 검사 목적에 따라 실손 보장 기준이 달라질 수 있습니다.', 110
WHERE NOT EXISTS (SELECT 1 FROM treatment_rules WHERE keyword = 'CT');
UPDATE treatment_rules
SET actual_loss_category = 'GENERAL_OUTPATIENT',
    caution_message      = 'CT는 급여/비급여 여부와 검사 목적에 따라 실손 보장 기준이 달라질 수 있습니다.'
WHERE keyword = 'CT'
  AND actual_loss_category = 'NON_COVERED_THREE';
INSERT INTO treatment_rules (keyword, synonyms, injury_disease_type, care_type, benefit_type, treatment_category, actual_loss_category, fixed_benefit_category, needs_user_confirmation, caution_message, priority)
...
INSERT INTO treatment_rules (keyword, synonyms, injury_disease_type, care_type, benefit_type, treatment_category, actual_loss_category, fixed_benefit_category, needs_user_confirmation, caution_message, priority)
SELECT '회전근개파열', '회전근개,어깨힘줄파열,극상근파열,극하근파열,어깨파열,회전근개손상', 'INJURY', 'OUTPATIENT', 'MIXED', 'GENERAL', 'GENERAL_OUTPATIENT', NULL, TRUE, '수술 여부가 확정되기 전에는 실손 중심으로 확인하고, 수술 시 수술비 담보를 별도로 확인해야 합니다.', 122
WHERE NOT EXISTS (SELECT 1 FROM treatment_rules WHERE keyword = '회전근개파열');
UPDATE treatment_rules
SET fixed_benefit_category = NULL,
    caution_message = '수술 여부가 확정되기 전에는 실손 중심으로 확인하고, 수술 시 수술비 담보를 별도로 확인해야 합니다.'
WHERE keyword = '회전근개파열'
  AND fixed_benefit_category = 'SURGERY_BENEFIT';
INSERT INTO treatment_rules (keyword, synonyms, injury_disease_type, care_type, benefit_type, treatment_category, actual_loss_category, fixed_benefit_category, needs_user_confirmation, caution_message, priority)
...
UPDATE fixed_benefit_match_rules
SET exclude_keywords = '실손의료비,통원의료비,입원의료비,의료비'
WHERE fixed_benefit_category = 'OUTPATIENT_DAILY';
INSERT INTO fixed_benefit_match_rules (fixed_benefit_category, display_name, match_keywords, exclude_keywords, description, priority)
